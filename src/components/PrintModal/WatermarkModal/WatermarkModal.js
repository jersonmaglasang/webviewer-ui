        ...
        <div className={'Modal Watermark'} data-element="watermarkModal" onMouseDown={this.closeModal}>
          <div className="form-container" data-element="formContainer" onMouseDown={e => e.stopPropagation()}>
            <div className="header-container" onMouseDown={e => e.stopPropagation()}>
              ...
              <ActionButton dataElement="watermarkModalCloseButton" title="action.close" img="ic_close_black_24px" onTouchStart={this.closeModal} onClick={this.closeModal} /> 
            </div>
            ...
            <div className="button-container">
              <a className="reset button" data-element="reset" onTouchStart={this.resetForm} onClick={this.resetForm}>{t(`option.watermark.resetAllSettings`)}</a>
              <div className="action-button-container">
                <button className="cancel button" data-element="cancel" onTouchStart={this.closeModal} onClick={this.closeModal}>{t(`action.cancel`)}</button>
                <button className="ok button" data-element="submit" onTouchStart={this.onOkPressed} onClick={this.onOkPressed}>{t(`action.ok`)}</button>
              </div>
            </div>
          </div>
        </div>
